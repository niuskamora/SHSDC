                                            ...
                                            if (isset($ValijasDestino)) {
                                                if (!isset($ValijasDestino[0])) {
                                                    ...
                                                    <tr class="success">     
                                                        ...
                                                        <td style='text-align:center'><?php echo utf8_encode($ValijasDestino["origenval"]); ?></td>
                                                        <td style='text-align:center'><?php echo utf8_encode($ValijasDestino["destinoval"]["nombresed"]); ?></td>
                                                    ...
                                                    for ($i = 0; $i < count($ValijasDestino); $i++) {
                                                        ...
                                                        <tr class="success">     
                                                            ...
                                                            <td style='text-align:center'><?php echo utf8_encode($ValijasDestino[$i]["origenval"]); ?></td>
                                                            <td style='text-align:center'><?php echo utf8_encode($ValijasDestino[$i]["destinoval"]["nombresed"]); ?></td>
                                            ...
                                            if (isset($ValijasOrigen)) {
                                                if (!isset($ValijasOrigen[0])) {
                                                    ...
                                                    <tr class="info">     
                                                        ...
                                                        <td style='text-align:center'><?php echo utf8_encode($ValijasOrigen["origenval"]); ?></td>
                                                        <td style='text-align:center'><?php echo utf8_encode($ValijasOrigen["destinoval"]["nombresed"]); ?></td>
                                                    ...
                                                    for ($i = 0; $i < count($ValijasOrigen); $i++) {
                                                        ...
                                                        <tr class="info">     
                                                            ...
                                                            <td style='text-align:center'><?php echo utf8_encode($ValijasOrigen[$i]["origenval"]); ?></td>
                                                            <td style='text-align:center'><?php echo utf8_encode($ValijasOrigen[$i]["destinoval"]["nombresed"]); ?></td>
